    ...
    <div class="row ">
      <div class="col-sm-4">
        ...
        <div class="card items-card">
          <img src="../images/cakes/butterscotch.jpg" class="card-img-top " alt="...">
      ...
      <form action="../manage-cart.php" method="POST">
        <div class="card items-card">
          <img src="../images/cakes/chocolate.jpg" class="card-img-top" alt="...">
          <div class="card-body item-body">
      ...
      <form action="../manage-cart.php" method="POST">
        <div class="card items-card">
          <img src="../images/cakes/ferrero -rocher.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Ferrero Rocher Cake</h5>
      ...
      <form action="../manage-cart.php" method="POST">
        <div class="card items-card">
          <img src="../images/cakes/red-velvet.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Red Velvet Cake</h5>
            <p class="card-text">₹650</p>
            <input type="hidden" name="Item_Name" value="red velvet">
      ...
      <form action="../manage-cart.php" method="POST">
        <div class="card items-card">
          <img src="../images/cakes/strawberry.jpg" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <form action="../manage-cart.php" method="POST">
        <div class="card items-card">
          <img src="../images/cakes/vanilla.jpg" class="card-img-top" alt="...">
          <div class="card-body">
